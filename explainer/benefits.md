...
The North-Easting or the East-Northing coordinate notattion system has many incoherent formats where some application use spaces, bearings, commas, minutes, degrees and seconds in differnt ways. Even barcoding a coordinate is since the degree symbol or the commas are not supported in various machines.
